...
const _commonPattern=[
  ...
  'องค์ประกอบขององค์พระ','ใบหน้า / พระพักตร์','ฐาน',
  'รายละเอียดพิมพ์','เส้นสายสำคัญ','ตำแหน่งองค์ประกอบ',
];

const _commonDetail=[
  'ตำหนิเฉพาะพิมพ์','ลักษณะเนื้อ','มวลสาร',
  'การกระจายตัวของมวลสาร','เนื้อว่าน / ส่วนผสมพิเศษ',
  'ลักษณะผิว','คราบธรรมชาติ','คราบกรุ','การยุบตัวของเนื้อ',
  'รอยแตกราน','ร่องรอยการกดพิมพ์','ร่องรอยจากแม่พิมพ์',
  'รอยตัดขอบ / รอยแต่ง','ร่องรอยการสร้าง'
];

final amuletPatternPoints=<String,List<String>>{
  'เหรียญ':[
    'รูปทรงและขนาดสัดส่วน','พิมพ์และรูปแบบเหรียญ',
    'ใบหน้า / รูปเหมือน','ตัวหนังสือ','ตัวเลข / ศักราช',
    'ลวดลายและองค์ประกอบ','เส้นขอบเหรียญ','หูเหรียญ',
    'โค้ด / ตอกโค้ด','รอยปั๊ม / รอยพิมพ์'
  ],
  'เหรียญหล่อ':[
    'รูปทรงและสัดส่วน','พิมพ์และรูปแบบ','ใบหน้า / รูปเหมือน',
    'ตัวหนังสือ / อักขระ','ตัวเลข / ศักราช',
    'ลวดลายและองค์ประกอบ','เส้นขอบเหรียญ','ก้นพระ',
    'โค้ดตอก','รอยประกบพิมพ์'
  ],
  'พระสมเด็จ':[
    'รูปทรงองค์พระ','พิมพ์ทรง','ความเอียงของพิมพ์',
    'สัดส่วนองค์พระ','ซุ้ม','พระเกศ','ใบหน้า / พระพักตร์',
    'องค์ประกอบขององค์พระ','ฐาน','รายละเอียดพิมพ์','เส้นสายสำคัญ'
  ],
  'รูปหล่อ':[
    'รูปทรงและสัดส่วน','พิมพ์และรูปแบบ','ใบหน้า / รูปเหมือน',
    'ตัวหนังสือ / อักขระ','ตัวเลข / ศักราช',
  ...
  'หลวงปู่ทวดหลังเตารีด':[
    'รูปทรงและสัดส่วน','พิมพ์และรูปแบบ','ใบหน้า / รูปเหมือน',
    'ตัวหนังสือ / อักขระ','ตัวเลข / ศักราช',
    'ลวดลายและองค์ประกอบ','ก้นพระ','โค้ดตอก',
    'รอยประกบพิมพ์','รอยปั้ม / รอยพิมพ์',
...
List<String> patternPointsFor(String type){
  return amuletPatternPoints[type]??_commonClayPattern;
}
...
List<String> detailPointsFor(String type){
  switch(type){
    ...
    case 'หลวงปู่ทวดหลังเตารีด':
      return [
        'ตำหนิเฉพาะพิมพ์','รอยตะไบ','รอยแต่งขอบ',
        'รอยเทหล่อ','รอยชนวน / รอยตัดชนวน',
        'รอยยุบ / รอยพรุนจากการหล่อ',
        'ผิวโลหะและคราบธรรมชาติ','ผิว',
        'เส้นหล่อ / ร่องรอยการสร้าง','เนื้อโลหะ'
      ];
    case 'พระปิดตาเนื้อผง/หว้าน':
      return [
        'ลักษณะเนื้อ','ลักษณะผิว',
    ...
    case 'หลวงปู่ทวดเนื้อหว้าน':
      return [
        'เนื้อหว่าน','มวลสาร','การกระจายตัวของมวลสาร',
        'ผิว','คราบกรุ','คราบหว่าน','รอยตัดขอบ',
        'ร่องรอยการกดพิมพ์','ร่องรอยจากแม่พิมพ์',
        'ตำหนิเฉพาะพิมพ์'
      ];
    case 'อื่น ๆ':
...
class AmuletData{
  ...
  AmuletData({
    ...
    this.temple='',this.province='',this.year='',this.material='',
    this.size='',this.frontDetail='',this.sideDetail='',
    this.backDetail='',List<ScanData>? scans,
  }):scans=scans??[];
...
Map<String,dynamic> toAiData(AmuletData e)=> {
  ...
  'patternObservationPoints':patternPointsFor(e.type),
  'detailObservationPoints':detailPointsFor(e.type),
  'analysisOrder':[
    'pattern_first',
    'detail_second',
  ...
  'smallDetailRule':{
    ...
    'doNotInterpretAs':'ไม่มีตำหนิหรือไม่มีรายละเอียด'
  },
  ...
  'referenceComparison':{
    ...
    'patternResult':null,'detailResult':null,
    'needsCloseup':[]
  },
  'aiContext':{
    ...
    'patternIsPrimaryVisualComparison':true,
    'detailsAreSupportingEvidence':true,
  ...
  Future<void> deleteItem(AmuletData item)async{
    final ok=await showDialog<bool>(
      ...
      builder:(c)=>AlertDialog(
        ...
        content:const Text('ต้องการลบรายการนี้ทั้งหมดหรือไม่?'),
        actions:[
          TextButton(onPressed:()=>Navigator.pop(c,false),child:const Text('ยกเลิก')),
          FilledButton(onPressed:()=>Navigator.pop(c,true),child:const Text('ลบ')),
        ],
...
class _ScanPageState extends State<ScanPage>{
    ...
    final s=ScanData(
      ...
      details:{
        ...
        'authenticityDecision':{
          ...
          'result':null,
          'note':
            'ข้อมูลพิมพ์และรายละเอียดใช้สำหรับการเปรียบเทียบ '
            'ไม่ตัดสินแท้/เก๊จากจุดใดจุดหนึ่งเพียงอย่างเดียว'
        },
      },
      imageFeatures:{
        'modelName':'',
  ...
  Widget observationSection(String title,List<String> list,IconData icon){
    return Column(
      crossAxisAlignment:CrossAxisAlignment.start,
      children:[
  ...
  Widget build(BuildContext c){
    ...
    final pattern=patternPointsFor(widget.item.type);
    final detail=detailPointsFor(widget.item.type);
            ...
            child:Padding(
              ...
              child:Column(
                ...
                children:[
                  ...
                  const SizedBox(height:6),
                  const Text(
                    'ระบบจะให้ความสำคัญกับพิมพ์พระก่อน '
                    'แล้วจึงใช้รายละเอียดอื่นเป็นข้อมูลประกอบ',
                  ),
                  const SizedBox(height:12),
                  observationSection(
                    '1. พิมพ์พระ — จุดหลัก',
                  ...
                  observationSection(
                    '2. รายละเอียดประกอบ — ใช้ยืนยันเพิ่มเติม',
                    detail,
                    Icons.search,
                  ),
                  const SizedBox(height:14),
                  Container(
                    ...
                    child:const Text(
                      '3. จุดที่ต้องนำไปเปรียบเทียบกับองค์อ้างอิง\n'
                      'หากรายละเอียดเล็กเกินไป ภาพไม่ชัด หรือข้อมูลไม่เพียงพอ '
                      'ให้ระบุว่า “ยังตรวจสอบไม่ได้ / ภาพไม่ละเอียดพอ” '
                      'ไม่ตีความว่าไม่มีตำหนิ',
                    ),
                  ),
                ],
              ),
          ...
          Card(
            child:Padding(
              ...
              child:Column(
                crossAxisAlignment:CrossAxisAlignment.start,
                children:[
                  const Text('หลักการวิเคราะห์',
                    style:TextStyle(fontSize:18,fontWeight:FontWeight.bold)),
                  const SizedBox(height:8),
                  const Text(
                    'พิมพ์พระเป็นข้อมูลหลักที่ควรตรวจจากภาพรวมก่อน '
                    'เพราะเป็นสิ่งที่สามารถสังเกตได้ด้วยตาเปล่า',
                  ),
                  const SizedBox(height:6),
                  const Text(
                    'รายละเอียดขนาดเล็ก เช่น ตำหนิ มวลสาร หรือร่องรอยบางชนิด '
                    'อาจต้องใช้ภาพความละเอียดสูงหรือสแกนเฉพาะจุด',
                  ),
                  const SizedBox(height:6),
                  const Text(
                    'ถ้าภาพไม่เพียงพอ ระบบควรแจ้งให้สแกนเพิ่ม '
                    'แทนการเดาว่าไม่มีรายละเอียดนั้น',
                  ),
                ],
              ),
            ),
            ...
            child:Padding(
              ...
              child:Column(
                ...
                children:[
                  ...
                  const SizedBox(height:6),
                  const Text(
                    'ระบบเตรียมข้อมูลสำหรับ AI โดยยังไม่เก็บรูปภาพต้นฉบับ',
                  ),
                  const SizedBox(height:10),
                  OutlinedButton.icon(
                    onPressed:()=>go(c,AiReconstructionPage(
            ...
            child:Padding(
              ...
              child:Column(
                ...
                children:[
                  ...
                  const SizedBox(height:6),
                  const Text(
                    'AI สามารถสร้าง Reference Model จากข้อมูลอ้างอิงหลายแหล่งได้ '
                    'โดยไม่ใช้ขนาดพิกเซลของรูปแทนขนาดจริง',
                  ),
                  const SizedBox(height:6),
                  const Text(
                    'ยังไม่ใช่การวัดองค์จริง และจะไม่ใช้ขนาดเพียงอย่างเดียวในการตัดสินความแท้',
                  ),
                ],
              ),
            ),
            ...
            child:Padding(
              ...
              child:Row(
                children:[
                  ...
                  Expanded(
                    child:Text(
                      'ความเป็นส่วนตัว: ภาพจากกล้องหรือโทรศัพท์ใช้ชั่วคราว '
                      'ไม่บันทึกรูปภาพ และไม่เก็บไฟล์ภาพลงฐานข้อมูล',
                    ),
                  ),
                ],
              ),
...
class _BackupPageState extends State<BackupPage>{
  ...
  Future<void> restore()async{
    ...
    try{
      ...
      final list=(data['items'] as List).map(
        (e)=>AmuletData.fromMap(Map<String,dynamic>.from(e)),
      ).toList();
...
class _SettingsPageState extends State<SettingsPage>{
  ...
  Widget build(BuildContext c)=>Scaffold(
    ...
    body:ListView(
      children:[
        SwitchListTile(
          title:const Text('เริ่มต้นเป็นสแกนองค์จริง'),
          value:real,
          onChanged:(v){
            setState(()=>real=v);
            setSetting('setting_real_object_default',v);
          },
        ),
        SwitchListTile(
          ...
          onChanged:(v){
            setState(()=>history=v);
            setSetting('setting_show_scan_history',v);
          },
        ),
        SwitchListTile(
          ...
          onChanged:(v){
            setState(()=>auto=v);
            setSetting('setting_auto_next_area',v);
          },
        ),
        const Divider(),
        const ListTile(
          leading:Icon(Icons.visibility_outlined),
          title:Text('หลักการวิเคราะห์'),
          subtitle:Text(
            'AI จะให้ความสำคัญกับพิมพ์พระก่อน '
            'แล้วใช้รายละเอียดเล็ก ๆ เป็นข้อมูลประกอบ '
            'หากภาพไม่ละเอียดพอจะระบุว่าไม่สามารถตรวจสอบได้',
          ),
        ),
        const ListTile(
          ...
          subtitle:Text(
            'เป็นเพียงระดับพื้นฐาน/ตัวเตือนความจำ '
            'ไม่จำกัดจำนวนองค์ สามารถเพิ่มข้อมูลได้เรื่อย ๆ',
          ),
        ),
        const ListTile(
          ...
          subtitle:Text(
            'ภาพสแกนใช้ชั่วคราวเพื่อการประมวลผล '
        ...
        const ListTile(
          ...
          subtitle:Text(
            'AI จะใช้ข้อมูลขนาดจากแหล่งอ้างอิง '
            'ไม่ใช้จำนวนพิกเซลของภาพ และไม่ถือว่าเป็นการวัดองค์จริง',
          ),
        ),
      ],
    ),
...
class AiReconstructionPage extends StatelessWidget{
        ...
        children:[
          Card(
            child:Padding(
              ...
              child:Column(
                children:[
                  Text('พื้นที่: ${scan.area}',
                    style:const TextStyle(fontSize:18,fontWeight:FontWeight.bold)),
                  const SizedBox(height:16),
                  SizedBox(
                    height:260,
                    child:CustomPaint(
                      painter:AiReconstructionPainter(active:active),
                    ),
                  ),
                ],
              ),
          ...
          Card(
            child:Padding(
              ...
              child:Column(
                crossAxisAlignment:CrossAxisAlignment.start,
                children:[
                  const Text('ลำดับการวิเคราะห์',
                    style:TextStyle(fontSize:18,fontWeight:FontWeight.bold)),
                  const SizedBox(height:10),
                  _aiRow('1','พิมพ์พระ','ชั้นหลัก — เปรียบเทียบรูปแบบที่มองเห็นได้'),
                  _aiRow('2','รายละเอียดประกอบ','ใช้ยืนยันเพิ่มเติม'),
                  _aiRow('3','รายละเอียดเล็ก','ตรวจเมื่อคุณภาพภาพเพียงพอ'),
                  _aiRow('4','จุดที่ต้องสแกนเพิ่ม','เมื่อภาพเดิมไม่ละเอียดพอ'),
                ],
              ),
            ),
          ),
          Card(
            child:Padding(
              ...
              child:Column(
                crossAxisAlignment:CrossAxisAlignment.start,
                children:[
                  const Text('โครงสร้างที่ AI เข้าใจ',
                    style:TextStyle(fontSize:18,fontWeight:FontWeight.bold)),
                  const SizedBox(height:10),
                  ...[
                    'พิมพ์พระ',
                    ...
                    subtitle:Text(
                      e=='พิมพ์พระ'
                        ?'เป็นชั้นหลักของการเปรียบเทียบ'
                        :e==_comparePoint
                          ?'ตรวจความแตกต่างกับองค์อ้างอิง'
                          :'รอระบบ AI วิเคราะห์',
                    ),
                  )),
                ],
          ...
          const Card(
            child:Padding(
              padding:EdgeInsets.all(14),
              child:Text(
                'หากรายละเอียดมีขนาดเล็กเกินไปหรือภาพไม่ละเอียดพอ '
                'ระบบควรระบุว่า “ยังตรวจสอบไม่ได้ / ภาพไม่ละเอียดพอ” '
                'และเสนอให้สแกนเฉพาะจุดเพิ่ม '
                'แทนการสรุปว่าไม่มีรายละเอียดนั้น\n\n'
                'Reference Model จะสร้างจากข้อมูลอ้างอิงหลายแหล่ง '
                'และขนาด/สัดส่วนเป็นเพียงหลักฐานประกอบ '
  ...
  Widget _aiRow(String n,String title,String sub)=>ListTile(
    dense:true,
...
class AiReconstructionPainter extends CustomPainter{
  ...
  @override
  bool shouldRepaint(covariant AiReconstructionPainter old)=>
      old.active!=active;
}
