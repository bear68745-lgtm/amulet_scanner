...
const amuletObservationPoints={
  'เหรียญ':[
    'รูปแบบตัวเหรียญ','ตัวหนังสือ','ตัวเลข','ลวดลาย','เส้นขอบ',
    'ผิวเหรียญ','รอยตอก/รอยปั๊ม','หูเหรียญ'
  ],
  'เหรียญหล่อ':[
  ...
  'พระปิดตาเนื้อโลหะ':[
    'รูปทรงองค์พระ','มือ/แขน','รายละเอียดพิมพ์',
    'ยันต์/อักขระ','ตัวหนังสือ','ตัวเลข','เส้นหล่อ',
    'ผิวโลหะ','รอยตัด/รอยตัดชนวน','ขอบ','ก้นพระ'
  ],
  'พระเนื้อผง':[
...
class _AmuletGroupPageState extends State<AmuletGroupPage>{
  ...
  @override Widget build(BuildContext c)=>Scaffold(
    appBar:AppBar(title:Text(
      widget.group.first.name.isEmpty?'รายการอ้างอิง':
    ...
    return Scaffold(
      ...
      body:ListView(padding:const EdgeInsets.all(12),children:[
        ...
        Card(child:Padding(
          padding:const EdgeInsets.all(14),
          child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
            Text('จุดสังเกต • ${widget.item.type.isEmpty?'อื่น ๆ':
              widget.item.type}',
        ...
        Card(child:Padding(
          ...
          child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
            ...
            const SizedBox(height:6),
            const Text(
              'AI สามารถสร้าง Reference Model จากข้อมูลอ้างอิง '
              'หลายแหล่งได้ โดยไม่ใช้ขนาดพิกเซลของรูปแทนขนาดจริง'),
            const SizedBox(height:6),
            const Text(
              'ยังไม่ใช่การวัดองค์จริง และจะไม่ใช้ขนาดเพียงอย่างเดียว '
              'ในการตัดสินความแท้'),
          ]),
        )),
        Card(child:Padding(
  ...
  @override Widget build(BuildContext c)=>Scaffold(
    ...
    body:ListView(children:[
      ...
      const ListTile(
        ...
        subtitle:Text(
          'AI จะใช้ข้อมูลขนาดจากแหล่งอ้างอิง ไม่ใช้จำนวนพิกเซลของภาพ '
          'และไม่ถือว่าเป็นการวัดองค์จริง'),
      ),
    ]),
  );
}
...
class AiReconstructionPainter extends CustomPainter{
  ...
  @override void paint(Canvas c,Size s){
    ...
    final r=RRect.fromRectAndRadius(
      Rect.fromCenter(
        center:s.center,width:s.width*.55,height:s.height*.75),
  ...
  @override bool shouldRepaint(
    covariant AiReconstructionPainter old)=>old.active!=active;
}
