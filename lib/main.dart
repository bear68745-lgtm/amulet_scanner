...
const amuletTypes=[
  'เหรียญ','เหรียญหล่อ','พระสมเด็จ','รูปหล่อ','พระกริ่ง','พระปิดต',
  'พระปิดตาเนื้อโลหะ','พระเนื้อผง','พระเนื้อดิน','นางพญา','ผงสุพรรณ',
  'พระรอด','พระซุ้มกอ','พระขุนแผน','อื่น ๆ'
];

const scanAreas=['ด้านหน้า','ด้านหลัง','ขอบข้าง','หูเหรียญ','ตูดพระ','จุดเฉพาะ'];
...
const amuletObservationPoints={
  'เหรียญ':['รูปแบบตัวเหรียญ','ตัวหนังสือ','ตัวเลข','ลวดลาย','เส้นขอบ','ผิวเหรียญ','รอยตอก/รอยปั๊ม','หูเหรียญ'],
  'เหรียญหล่อ':['รูปทรง','ลวดลาย','เส้นหล่อ','รอยตัดชนวน','ผิวโลหะ','รูพรุน','ขอบ','หูเหรียญ'],
  'พระสมเด็จ':['พิมพ์ทรง','ซุ้ม','องค์พระ','ฐาน','เส้นสายสำคัญ','เนื้อ','ผิว/คราบ','รอยตัดขอบ'],
  'รูปหล่อ':['รูปทรง','ใบหน้า','สัดส่วน','ฐาน','รายละเอียดองค์พระ','เส้นหล่อ','ผิวโลหะ','ก้นพระ'],
  'พระกริ่ง':['รูปทรง','ใบหน้า','รายละเอียดองค์พระ','ฐาน','เส้นหล่อ','ผิวโลหะ','ก้นพระ','รู/ช่องก้น'],
  'พระปิดตา':['รูปทรงองค์พระ','มือ/แขน','ใบหน้า','ฐาน','รายละเอียดพิมพ์','ยันต์/อักขระ','ตัวหนังสือ','ตัวเลข','ลักษณะเนื้อ','ลักษณะผิว','มวลสาร/การกระจายตัวของมวลสาร','ร่องรอยการกดพิมพ์','ขอบ','รอยตัดแต่ง'],
  'พระปิดตาเนื้อโลหะ':['รูปทรงองค์พระ','มือ/แขน','รายละเอียดพิมพ์','ยันต์/อักขระ','ตัวหนังสือ','ตัวเลข','เส้นหล่อ','ผิวโลหะ','รอยตัด/รอยตัดชนวน','ขอบ','ก้นพระ'],
  'พระเนื้อผง':['พิมพ์ทรง','องค์พระ','ฐาน','รายละเอียดพิมพ์','เนื้อ','ผิว','คราบ','รอยตัดขอบ'],
  'พระเนื้อดิน':['พิมพ์ทรง','องค์พระ','ฐาน','รายละเอียดพิมพ์','เนื้อดิน','ผิว','คราบกรุ','รอยตัดขอบ'],
  'นางพญา':['พิมพ์ทรง','องค์พระ','ใบหน้า','ฐาน','รายละเอียดพิมพ์','เนื้อ','ผิว','รอยตัดขอบ'],
  'ผงสุพรรณ':['พิมพ์ทรง','องค์พระ','ใบหน้า','ฐาน','รายละเอียดพิมพ์','เนื้อ','ผิว','คราบกรุ','รอยตัดขอบ'],
  'พระรอด':['พิมพ์ทรง','องค์พระ','ซุ้ม','ฐาน','รายละเอียดพิมพ์','เนื้อ','ผิว','คราบกรุ'],
  'พระซุ้มกอ':['พิมพ์ทรง','องค์พระ','ซุ้ม','ฐาน','รายละเอียดพิมพ์','เนื้อ','ผิว','คราบกรุ'],
  'พระขุนแผน':['พิมพ์ทรง','องค์พระ','รายละเอียดใบหน้า','แขน/มือ','ฐาน','เนื้อ','ผิว','คราบกรุ'],
  'อื่น ๆ':['พิมพ์ทรง','รายละเอียดองค์พระ','ลวดลาย','ขอบ','เนื้อ','ผิว','รอยตำหนิ','รายละเอียดเฉพาะรุ่น'],
};
...
Map<String,dynamic> toAiData(AmuletData e)=> {
  ...
  'aiContext':{
    ...
    'canAddAnalysis':true,'canCompareAreas':true,'canBuildReferenceModel':true,
    'canUseReferenceSize':true,'sizeMustComeFromReferenceData':true,
    'imagePixelsAreNotRealSize':true,'doNotJudgeAuthenticityFromSizeAlone':true,
  },
};
...
Future<List<AmuletData>> loadAllItems()async{
  ...
  try{
    ...
    if(z!=null&&z.isNotEmpty){
      final raw=base64Decode(z);
      final json=utf8.decode(gzip.decode(raw));
...
class HomePage extends StatelessWidget{
  ...
  Widget tile(BuildContext c,String t,String s,IconData i,Widget p)=>
    Card(child:ListTile(
      leading:Icon(i,size:32),title:Text(t,
  ...
  @override Widget build(BuildContext c)=>Scaffold(
    ...
    body:ListView(padding:const EdgeInsets.all(12),children:[
      ...
      tile(c,'สำรอง / นำเข้าข้อมูล','สำรองหรือนำข้อมูลกลับเข้าเครื่อง',
        Icons.import_export,BackupPage()),
      ...
      body:Column(children:[
        Padding(padding:const EdgeInsets.all(12),child:TextField(
          ...
          decoration:const InputDecoration(
            prefixIcon:Icon(Icons.search),labelText:'ค้นหา',
            border:OutlineInputBorder()),
        )),
        Expanded(child:gs.isEmpty?const Center(child:Text('ยังไม่มีข้อมูล')):
          ListView(
            padding:const EdgeInsets.fromLTRB(12,0,12,12),
            children:gs.entries.map((g){
              final a=g.value.first;
              return Card(child:ListTile(
                leading:CircleAvatar(child:Text('${g.value.length}')),
                title:Text(a.name.isEmpty?'ไม่ระบุชื่อ':a.name),
                subtitle:Text('${a.model.isEmpty?'ไม่ระบุรุ่น':a.model}'
...
class _EditGroupPageState extends State<EditGroupPage>{
  ...
  @override void dispose(){
    name.dispose();model.dispose();pim.dispose();
    temple.dispose();super.dispose();
  }
    ...
    body:ListView(padding:const EdgeInsets.all(12),children:[
      Card(child:Padding(
        ...
        child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
          Text(widget.group.first.name.isEmpty?'ไม่ระบุชื่อ':widget.group.first.name,
      ...
      ...group.asMap().entries.map((x){
        final n=x.key+1,e=x.value;
        return Card(child:ListTile(
          leading:CircleAvatar(child:Text('$n')),
          title:Text('องค์จริง • ID ${e.id}'),
...
class _ScanPageState extends State<ScanPage>{
          ...
          builder:(c)=>AlertDialog(
            ...
            content:SizedBox(
              ...
              child:Column(children:[
                Expanded(child:camera!.value.isInitialized
  ...
  Future<void> addCustomArea()async{
    ...
    final ok=await showDialog<bool>(
      context:context,builder:(d)=>AlertDialog(
        title:const Text('เพิ่มพื้นที่สแกน'),
        content:TextField(controller:c,decoration:
          const InputDecoration(labelText:'ชื่อพื้นที่')),
        actions:[
      ...
      body:ListView(padding:const EdgeInsets.all(12),children:[
        ...
        Card(child:Padding(
          ...
          child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
            ...
            const SizedBox(height:8),Text(area),
        ...
        Card(child:Padding(
          padding:const EdgeInsets.all(14),
          child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
            Text('จุดสังเกต • ${widget.item.type.isEmpty?'อื่น ๆ':widget.item.type}',
        ...
        if(history)Card(child:Padding(
          ...
          child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
            ...
            if(widget.item.scans.isEmpty)
              ...
              ...widget.item.scans.asMap().entries.map((x){
                final s=x.value;
                return ListTile(
                  dense:true,leading:const Icon(Icons.check_circle_outline),
                  title:Text('${x.key+1}. ${s.area}'),subtitle:Text(s.method),
        ...
        Card(child:Padding(
          ...
          child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
            ...
            const SizedBox(height:6),
            const Text('AI สามารถสร้าง Reference Model จากข้อมูลอ้างอิง หลายแหล่งได้ โดยไม่ใช้ขนาดพิกเซลของรูปแทนขนาดจริง'),
            const SizedBox(height:6),
            const Text('ยังไม่ใช่การวัดองค์จริง และจะไม่ใช้ขนาดเพียงอย่างเดียว ในการตัดสินความแท้'),
          ]),
        )),
        Card(child:Padding(
          padding:const EdgeInsets.all(14),
          child:Row(children:[
            const Icon(Icons.lock_outline),const SizedBox(width:10),
            const Expanded(child:Text('ความเป็นส่วนตัว: ภาพจากกล้องหรือโทรศัพท์ใช้ชั่วคราว ไม่บันทึกรูปภาพ และไม่เก็บไฟล์ภาพลงฐานข้อมูล')),
          ]),
        )),
      ]),
    );
...
class _BackupPageState extends State<BackupPage>{
  ...
  Future<void> restore()async{
    ...
    try{
      ...
      final list=(data['items'] as List).map((e)=>
        AmuletData.fromMap(Map<String,dynamic>.from(e))).toList();
      if(!mounted)return;
      final ok=await showDialog<bool>(
        context:context,builder:(c)=>AlertDialog(
  ...
  @override Widget build(BuildContext c)=>Scaffold(
    ...
    body:ListView(padding:const EdgeInsets.all(12),children:[
      Card(child:ListTile(
        leading:const Icon(Icons.upload_file),title:const Text('สำรองข้อมูล'),
        subtitle:const Text('สร้างไฟล์ JSON โดยไม่มีรูปภาพ'),onTap:backup)),
      Card(child:ListTile(
        leading:const Icon(Icons.download),title:const Text('นำเข้าข้อมูล'),
        subtitle:const Text('นำข้อมูลจากไฟล์ JSON กลับเข้าเครื่อง'),onTap:restore)),
      const SizedBox(height:12),
      Card(child:ListTile(
        leading:const Icon(Icons.delete_forever),title:const Text('ลบข้อมูลทั้งหมด'),
        subtitle:const Text('ลบรายการที่บันทึกและประวัติการสแกนทั้งหมด'),onTap:deleteAll)),
    ]),
  );
}
...
class _SettingsPageState extends State<SettingsPage>{
  ...
  Future<void> set(String k,bool v)async{
    final p=await prefs();await p.setBool(k,v);
  }
  ...
  @override Widget build(BuildContext c)=>Scaffold(
    ...
    body:ListView(children:[
      SwitchListTile(
        ...
        onChanged:(v){setState(()=>real=v);set('setting_real_object_default',v);}),
      SwitchListTile(
        title:const Text('แสดงประวัติการสแกน'),value:history,
        onChanged:(v){setState(()=>history=v);set('setting_show_scan_history',v);}),
      SwitchListTile(
        title:const Text('ไปพื้นที่ถัดไปอัตโนมัติ'),value:auto,
        onChanged:(v){setState(()=>auto=v);set('setting_auto_next_area',v);}),
      const Divider(),
      const ListTile(
        leading:Icon(Icons.info_outline),title:Text('พื้นฐาน 5+ องค์'),
        subtitle:Text('เป็นเพียงระดับพื้นฐาน/ตัวเตือนความจำ ไม่จำกัดจำนวนองค์ สามารถเพิ่มข้อมูลได้เรื่อย ๆ')),
      const ListTile(
        leading:Icon(Icons.photo_camera_back_outlined),title:Text('นโยบายรูปภาพ'),
        subtitle:Text('ภาพสแกนใช้ชั่วคราวเพื่อการประมวลผล และไม่บันทึกเป็นรูปภาพ')),
      const ListTile(
        leading:Icon(Icons.straighten),title:Text('ขนาดจากข้อมูลอ้างอิง'),
    ...
    body:ListView(padding:const EdgeInsets.all(16),children:[
      Card(child:Padding(
        ...
        child:Column(children:[
          ...
          SizedBox(height:260,child:CustomPaint(
            painter:AiReconstructionPainter(
              active:scan.imageFeatures['embedding'] is List&&
                (scan.imageFeatures['embedding'] as List).isNotEmpty),
          )),
        ]),
      )),
      Card(child:Padding(
        ...
        child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
          ...
          ...[
            ...
            dense:true,leading:const Icon(Icons.auto_awesome),title:Text(e),
      ...
      Card(child:Padding(
        padding:const EdgeInsets.all(14),
        child:const Text(
          'Reference Model จะสร้างจากข้อมูลอ้างอิงหลายแหล่ง โดยแยกขนาดจริงออกจากขนาดพิกเซลของภาพ และหากข้อมูลต่างกันจะเก็บเป็นช่วงหรือค่าหลายค่า แทนการเดาตัวเลขเอง\n\n'
...
class AiReconstructionPainter extends CustomPainter{
  ...
  void paint(Canvas c,Size s){
    ...
    c.drawLine(
      Offset(s.width*.28,s.height*.62),
      Offset(s.width*.72,s.height*.62),
      p,
    );

    c.drawLine(
      Offset(s.width*.35,s.height*.70),
      Offset(s.width*.65,s.height*.70),
      p,
    );
  ...
  @override
  bool shouldRepaint(
    covariant AiReconstructionPainter old)=>
      old.active!=active;
}
