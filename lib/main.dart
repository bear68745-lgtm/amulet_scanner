...
class AiMemoryTest {
  String id, knowledgeId, referenceId, area;
  String question, answer, testedAt;
...
class Storage {
  ...
  // ---------------------------------------------------
  // REBUILD AI FROM CURRENT DATABASE
  // ---------------------------------------------------
