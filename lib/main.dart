...
class AmuletData {
  ...
  // แต่ไม่แสดงให้ผู้ใช้กรอกในหน้าสร้างใหม่
  // ===================================================
...
// AI DATA
// =====================================================
// ข้อมูลชุดนี้เตรียมไว้สำหรับส่งให้ระบบ AI
//
// สำคัญ:
// - ไม่ส่ง ID ภายในระบบ
// - ไม่ส่งเลของค์จริง
// - ไม่ส่งข้อมูลระบบที่ไม่เกี่ยวกับการวิเคราะห์
// - ไม่ส่งรูปภาพ
//
// เมื่อเชื่อม AI จริง ให้ใช้ toAiData(item)
// แทนการส่ง item.toMap()
...
class _CreateDataPageState
  ...
  Future<void> _saveData() async {
    try {
      ...
      // ถ้าค่าเดิมผิด ให้หาหมายเลขสูงสุดจากข้อมูลจริง
      if (nextNumber <= 0) {
        int maxNumber = 0;
              ...
              return Card(
                child: ListTile(
                  ...
                  onTap: () async {
                    ...
                    // =================================================
                    // แก้ปัญหาหน้าขาว "ไม่พบข้อมูล"
                    //
                    // ใช้ ID เป็นตัวอ้างอิงแทนชื่อ + รุ่น
                    // เพราะชื่อ/รุ่นอาจถูกแก้ไขภายหลัง
                    // =================================================
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text(
            ...
            'แล้วเลือกพื้นที่ที่ต้องการสแกน',
            style: TextStyle(
              fontSize: 15,
            ),
          ),
