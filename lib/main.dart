...
class _ReferenceListPageState
  ...
  //
  // สำคัญ:
  // ไม่เปิด CreateReferencePage
  // เปิด ScanPage โดยตรง
  // และส่งข้อมูลของกลุ่มเดิมเข้าไป
  // ===================================================
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ปุ่มนี้คือจุดที่แก้
      //
      // กดแล้วไป ScanPage ใหม่ทันที
      // ไม่ผ่านหน้า CreateReferencePage
      // =================================================
...
class _ScanPageState extends State<ScanPage> {
  ...
  Future<void> saveReference() async {
    ...
    try {
      ...
      //
      // จุดนี้ใช้ทั้ง:
      // 1. การสร้างองค์แรกจาก CreateReferencePage
      // 2. การเพิ่มองค์ใหม่จากปุ่ม + เพิ่มองค์อ้างอิง
      //
      // ข้อมูลกลุ่มจะถูกส่งเข้ามาจากหน้าก่อนหน้า
      // -----------------------------------------------
