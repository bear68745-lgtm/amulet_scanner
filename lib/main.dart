...
class App extends StatelessWidget{
  ...
  Widget build(BuildContext context)=>MaterialApp(
    ...
    title:'กล้องสแกนพระ',
    theme:ThemeData(
      useMaterial3:true,colorSchemeSeed:Colors.brown),
      ...
      body:knowledge.isEmpty
        ...
        :ListView(
          ...
          children:[
            ...
            const Text(
              'เลือกคำถามเอง หรือสุ่มจากความรู้ที่ AI เคยเรียน'),
              ...
              Card(
                child:Padding(
                  ...
                  child:Column(
                    ...
                    children:[
                      Text(randomMode?'🎲 คำถามสุ่ม':'📋 คำถามที่เลือก',
