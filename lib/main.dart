    ...
    return Scaffold(
      ...
      ListView.builder(
        ...
        itemBuilder:(_,i){
          ...
          // รวมองค์อ้างอิงจากทุกชนิด → ทุกพิมพ์ → ทุกองค์
      ...
      for(final m in g.models){
        ...
        for(final t in m.types){
          ...
          for(final savedPrint in t.prints){
            ...
            savedPrint.references.add(ref);
            Storage.renumber(savedPrint);
            await Storage.save(gs);
            if(!mounted)return;
...
class _ScanPageState extends State<ScanPage>{
  ...
  Future<void>scanCamera()async{
    if(widget.cameras.isEmpty){
      showMessage('ไม่พบกล้องในเครื่อง');
      return;
    }
