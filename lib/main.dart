...
class Storage{
  ...
  /* ===== จุดที่ 1 : AI เรียนรู้ข้อมูลสแกน ===== */
...
class ReferenceEditPage extends StatefulWidget{
  ...
  @override State<ReferenceEditPage> createState()=>
...
class _ReferenceEditPageState extends State<ReferenceEditPage>{
  ...
  /* ===== จุดที่ 2 : หลังบันทึก ให้ AI เรียนรู้ ===== */
  ...
  Future<void> scanArea(String area)async{
    ...
    // ส่งข้อมูลที่เพิ่งบันทึกเข้า AI Memory
