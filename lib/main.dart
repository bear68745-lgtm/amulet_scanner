...
const amuletObservationPoints={
  'เหรียญ':[
    ...
    'เส้นขอบเหรียญ','หูเหรียญ','โค้ด / ตอกโค้ด','รอยปั๊ม / รอยพิมพ์',
    'เนื้อโลหะ','ผิวเหรียญ','คราบและร่องรอยตามธรรมชาติ',
    'รอยตัด / รอยแต่งขอบ','ตำหนิเฉพาะพิมพ์','ร่องรอยการสร้าง',
  ...
  'เหรียญหล่อ':[
    ...
    'เส้นขอบเหรียญ','ก้นพระ','โค้ดตอก','รอยตะไบ',
    'รอยแต่งขอบ','รอยเทหล่อ','รอยชนวน / รอยตัดชนวน',
    'รอยประกบพิมพ์','รอยยุบ / รอยพรุนจากการหล่อ',
  ...
  'รูปหล่อ':[
    'รูปทรงและสัดส่วน','พิมพ์และรูปแบบ','ใบหน้า / รูปเหมือน',
    'ตัวหนังสือ / อักขระ','ตัวเลข / ศักราช','ลวดลายและองค์ประกอบ',
    'ก้นพระ','โค้ดตอก','รอยตะไบ','รอยแต่งขอบ',
    'รอยเทหล่อ','รอยชนวน / รอยตัดชนวน','รอยประกบพิมพ์',
    'รอยยุบ / รอยพรุนจากการหล่อ','ผิวโลหะและคราบธรรมชาติ',
    'ผิว','ตำหนิเฉพาะพิมพ์','เส้นหล่อ / ร่องรอยการสร้าง',
    'ความผิดปกติที่ควรเปรียบเทียบกับองค์อ้างอิง',
  ],
  'พระกริ่ง':[
    'รูปทรงและสัดส่วน','พิมพ์และรูปแบบ','ใบหน้า / รูปเหมือน',
  ...
  'พระปิดตาเนื้อผง/หว้าน':[
    ...
    'มวลสาร/การกระจายตัวของมวลสาร','ร่องรอยการกดพิมพ์','ขอบ',
    'รอยตัดแต่ง',
  ],
  'พระปิดตาเนื้อโลหะ':[
    'รูปทรงและสัดส่วน','พิมพ์และรูปแบบ','ใบหน้า / รูปเหมือน',
  ...
  'ผงสุพรรณ':[
    'พิมพ์ทรง','องค์พระ','ใบหน้า','ฐาน','รายละเอียดพิมพ์',
    'เนื้อ','ผิว','คราบกรุ','รอยตัดขอบ',
  ],
  'พระรอด':[
    'พิมพ์ทรง','องค์พระ','ซุ้ม','ฐาน','รายละเอียดพิมพ์',
    'เนื้อ','ผิว','คราบกรุ',
  ],
  'พระซุ้มกอ':[
    'พิมพ์ทรง','องค์พระ','ซุ้ม','ฐาน','รายละเอียดพิมพ์',
  ...
  'พระขุนแผน':[
    'พิมพ์ทรง','องค์พระ','รายละเอียดใบหน้า','แขน/มือ',
    'ฐาน','เนื้อ','ผิว','คราบกรุ',
  ],
  'หลวงปู่ทวดเนื้อหว้าน':[
    'รูปทรงองค์พระ','องค์พระ','ใบหน้า','พิมพ์ทรง','รายละเอียดพิมพ์',
    'ฐาน','เนื้อหว่าน','มวลสาร','การกระจายตัวของมวลสาร','ผิว',
    'คราบกรุ','รอยตัดขอบ','ร่องรอยการกดพิมพ์','ตำหนิเฉพาะพิมพ์',
  ],
  'หลวงปู่ทวด05':[
    'รูปทรงและสัดส่วน','พิมพ์และรูปแบบ','ใบหน้า / รูปเหมือน',
    'ตัวหนังสือ / อักขระ','ตัวเลข / ศักราช','ลวดลายและองค์ประกอบ',
    ...
    'รอยยุบ / รอยพรุนจากการหล่อ','ผิวโลหะและคราบธรรมชาติ',
    'ผิว','ตำหนิเฉพาะพิมพ์','เส้นหล่อ / ร่องรอยการสร้าง',
    'รอยปั้ม / รอยพิมพ์','ร่องรอยการปั้มซ้ำหลังการหล่อ',
    'ความผิดปกติที่ควรเปรียบเทียบกับองค์อ้างอิง',
  ],
  'อื่น ๆ':[
...
class AmuletData{
  ...
  AmuletData({
    ...
    this.size='',this.frontDetail='',this.sideDetail='',this.backDetail='',
    List<ScanData>? scans,
  }):scans=scans??[];

  Map<String,dynamic> toMap()=>{
    'id':id,'name':name,'model':model,'pim':pim,'type':type,
    'temple':temple,'province':province,'year':year,'material':material,
    'size':size,'frontDetail':frontDetail,'sideDetail':sideDetail,
    'backDetail':backDetail,'scans':scans.map((e)=>e.toMap()).toList(),
  };
...
class ScanData{
  ...
  Map<String,dynamic> toMap()=>{'area':area,'method':method,
    'details':details,'imageFeatures':imageFeatures};
...
Future<List<AmuletData>> loadAllItems()async{
  ...
  try{
    ...
    if(z!=null&&z.isNotEmpty){
      final json=utf8.decode(gzip.decode(base64Decode(z)));
    ...
    return Scaffold(
      ...
      body:Column(
        children:[
          ...
          Expanded(
            child:gs.isEmpty?const Center(child:Text('ยังไม่มีข้อมูล')):
            ListView(
        ...
        Card(
          child:Padding(
            ...
            child:Column(
              ...
              children:[
                Text(widget.group.first.name.isEmpty?'ไม่ระบุชื่อ':
                  widget.group.first.name,
                  style:const TextStyle(
                    fontSize:20,fontWeight:FontWeight.bold)),
                Text('รุ่น: ${widget.group.first.model.isEmpty?'ไม่ระบุ':
                  widget.group.first.model}'),
                Text('ชนิด: ${widget.group.first.type.isEmpty?'ไม่ระบุ':
                  widget.group.first.type}'),
                const SizedBox(height:6),
                const Text(
                  'พื้นฐาน 5+ องค์ เป็นเพียงตัวเตือน สามารถเพิ่มได้ไม่จำกัด'),
              ],
            ),
          ),
        ),
  ...
  Future<void> saveScan(String method)async{
    final s=ScanData(
      ...
      details:{
        ...
        'referenceComparison':{
          'enabled':true,'referenceModelAvailable':false,
          'result':null,'differences':[],'sizeDifference':null,
              ...
              child:Column(
                ...
                children:[
                  Text(widget.item.name.isEmpty?'ไม่ระบุชื่อ':widget.item.name,
                    style:const TextStyle(
                      fontSize:20,fontWeight:FontWeight.bold)),
                  Text('รุ่น: ${widget.item.model.isEmpty?'ไม่ระบุ':
                    widget.item.model}'),
                  Text('ชนิด: ${widget.item.type.isEmpty?'อื่น ๆ':
                    widget.item.type}'),
                  const SizedBox(height:6),
  ...
  Future<void> restore()async{
    ...
    try{
      ...
      final list=(data['items'] as List).map(
        (e)=>AmuletData.fromMap(Map<String,dynamic>.from(e))).toList();
      if(!mounted)return;
      final ok=await showDialog<bool>(
        context:context,builder:(c)=>AlertDialog(
          title:const Text('นำเข้าข้อมูล'),
          content:Text(
            'พบข้อมูล ${list.length} รายการ ต้องการแทนที่ข้อมูลเดิมหรือไม่?'),
          actions:[
            TextButton(onPressed:()=>Navigator.pop(c,false),
              child:const Text('ยกเลิก')),
            FilledButton(onPressed:()=>Navigator.pop(c,true),
  ...
  Future<void> deleteAll()async{
    final ok=await showDialog<bool>(
      context:context,builder:(c)=>AlertDialog(
        ...
        content:const Text(
          'ข้อมูลพระ รายการอ้างอิง และประวัติการสแกนทั้งหมดจะถูกลบ'),
        actions:[
          TextButton(onPressed:()=>Navigator.pop(c,false),
            child:const Text('ยกเลิก')),
          FilledButton(onPressed:()=>Navigator.pop(c,true),
    ...
    body:ListView(
      ...
      children:[
        ...
        Card(child:ListTile(
          ...
          title:const Text('ลบข้อมูลทั้งหมด'),
          subtitle:const Text(
            'ลบรายการที่บันทึกและประวัติการสแกนทั้งหมด'),
          onTap:deleteAll)),
      ],
    ),
  );
    ...
    body:ListView(
      children:[
        SwitchListTile(
          ...
          onChanged:(v){
            setState(()=>real=v);set('setting_real_object_default',v);
          }),
        SwitchListTile(
          title:const Text('แสดงประวัติการสแกน'),value:history,
          onChanged:(v){
            setState(()=>history=v);set('setting_show_scan_history',v);
          }),
        SwitchListTile(
          title:const Text('ไปพื้นที่ถัดไปอัตโนมัติ'),value:auto,
          onChanged:(v){
            setState(()=>auto=v);set('setting_auto_next_area',v);
          }),
        const Divider(),
        const ListTile(
          ...
          subtitle:Text(
            'เป็นเพียงระดับพื้นฐาน/ตัวเตือนความจำ ไม่จำกัดจำนวนองค์ สามารถเพิ่มข้อมูลได้เรื่อย ๆ')),
        const ListTile(
        ...
        const ListTile(
          ...
          subtitle:Text(
            'AI จะใช้ข้อมูลขนาดจากแหล่งอ้างอิง ไม่ใช้จำนวนพิกเซลของภาพ และไม่ถือว่าเป็นการวัดองค์จริง')),
      ],
    ),
  );
}
      ...
      children:[
          ...
          child:Padding(
            ...
            child:Column(
              ...
              children:[
                ...
                const SizedBox(height:10),
                ...[
                  'รูปร่างและสัดส่วน','ขนาดจากข้อมูลอ้างอิง','พื้นผิว',
                  'เนื้อ','ตำหนิ','รายละเอียดพิมพ์',
                  'ยันต์ / อักขระ / ตัวหนังสือ / ตัวเลข',
                  'เส้นหล่อ / ร่องรอยการสร้าง',
                  'การเปรียบเทียบองค์อ้างอิง','ข้อสังเกต','ความมั่นใจ',
                ].map((e)=>ListTile(
                  dense:true,leading:const Icon(Icons.auto_awesome),
                  title:Text(e),
                  subtitle:Text(
                    e=='ขนาดจากข้อมูลอ้างอิง'
        ...
        const Card(
          child:Padding(
            padding:EdgeInsets.all(14),
            child:Text(
              'หน้านี้เป็นโหมดเตรียมระบบ AI สำหรับ MediaPipe/LiteRT ยังไม่ใช่ผลวิเคราะห์จริง และภาพต้นฉบับไม่ได้ถูกบันท
