...
const amuletObservationPoints = {
  ...
  'พระสมเด็จ': [
    ...
    'การกระจายตัวของมวลสาร',
    'ลักษณะผิว',
    'คราบธรรมชาติ / คราบกรุ',
    'รอยตัดขอบ / รอยแต่ง',
    'รอยปั้มหมึก',
    'ร่องรอยการสร้าง / ร่องรอยจากแม่พิมพ์',
    _comparePoint,
  ],
...
class _EditGroupPageState
  ...
  Widget build(BuildContext c) => Scaffold(
        appBar: AppBar(
          title: const Text('แก้ไขข้อมูลกลุ่ม'),
        ),
        body: ListView(
          padding: const EdgeInsets.all(16),
          children: [
