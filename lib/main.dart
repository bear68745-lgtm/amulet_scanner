...
class ReferenceData {
  ...
  ReferenceData({
    required this.id,required this.referenceNumber,required this.createdAt,
    required this.updatedAt,this.scans=const[]});
  ...
  @override Widget build(BuildContext c){
    ...
    return Scaffold(
      appBar:AppBar(title:Text(g?.name??'รายการ'),actions:[
        FilledButton.icon(onPressed:addModel,icon:const Icon(Icons.add,size:22),
  ...
  @override Widget build(BuildContext c){
    ...
    return Scaffold(
      appBar:AppBar(title:Text('รุ่น ${m?.name??''}'),actions:[
        FilledButton.icon(onPressed:addType,icon:const Icon(Icons.add,size:22),
