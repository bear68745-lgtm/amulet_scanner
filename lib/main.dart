...
class _CreateReferencePageState
  ...
  bool get isSinglePrintType => selectedType == 'เหรียญ';

  void updatePrintByType(String type) {
    if (type == 'เหรียญ') {
      printController.text = 'พิมพ์นิยม';
    } else if (printController.text.trim() == 'พิมพ์นิยม') {
      printController.clear();
    }
  }
      ...
      body: ListView(
        ...
        children: [
          ...
          TextField(
            ...
            enabled: !isSinglePrintType,
            decoration: InputDecoration(
              labelText: 'พิมพ์',
              border: const OutlineInputBorder(),
              hintText: isSinglePrintType
                  ? 'ระบบกำหนดเป็น พิมพ์นิยม'
                  : 'กรอกชื่อพิมพ์',
            ),
          ),

          if (isSinglePrintType)
            const Padding(
              ...
              child: Text(
                'ชนิดเหรียญใช้พิมพ์เดียว ระบบกำหนดเป็น "พิมพ์นิยม"',
...
class _ReferencePageState extends State<ReferencePage> {
  ...
  Future<void> addReference() async {
    ...
    widget.print.references.add(
      ReferenceData(
        id: newId(),
        referenceNumber: await nextNumber(),
        createdAt: d,
        updatedAt: d,
      ),
    );
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: const Text('บันทึกข้อมูลสแกน'),
            ),
          ),
