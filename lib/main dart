...
const amuletObservationPoints={
  ...
  'เหรียญหล่อ':[
    'รูปทรง','ลวดลาย','เส้นหล่อ','รอยตัดชนวน','ผิวโลหะ',
    'รูพรุน','ขอบ','หูเหรียญ','โค้ดตอก','รอยตะไบ',
  ],
  'พระสมเด็จ':[
  ...
  'พระกริ่ง':[
    'รูปทรง','ใบหน้า','รายละเอียดองค์พระ','ฐาน','เส้นหล่อ',
    'ผิวโลหะ','ก้นพระ','รู/ช่องก้น',
  ],
...
class AiReconstructionPainter extends CustomPainter{
  ...
  void paint(Canvas c,Size s){
    ...
    if(active){
      c.drawCircle(
        Offset(s.width*.42,s.height*.45),5,p);
      c.drawCircle(
        Offset(s.width*.58,s.height*.45),5,p);
    }
  }
