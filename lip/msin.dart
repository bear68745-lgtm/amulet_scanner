...
List<String> observationPointsFor(String type) => [
      ...
      ...(amuletObservationPoints[type] ??
          amuletObservationPoints['อื่น ๆ']!)
    ];
  ...
  Map<String, List<AmuletData>> groups() {
    ...
    for (final e in items) {
      if (search.isNotEmpty &&
          !('${e.name} ${e.model} ${e.type} ${e.temple}')
              .toLowerCase()
    ...
    final s = ScanData(
      ...
      details: {
        ...
        'authenticityDecision': {
          ...
          'result': null,
          'note':
              'ขนาดและสัดส่วนใช้เป็นหลักฐานประกอบ ไม่ตัดสินแท้/เก๊เพียงอย่างเดียว',
        },
      },
      imageFeatures: {
        'modelName': '',
